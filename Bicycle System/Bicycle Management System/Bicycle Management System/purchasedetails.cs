...
namespace Bicycle_Management_System
{
    public partial class purchasedetails : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'databaseDataSet2.purchase' table. You can move, or remove it, as needed.
            this.purchaseTableAdapter.Fill(this.databaseDataSet2.purchase);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from purchase where modelno='" + textBox1.Text + "'";
            cmd.ExecuteNonQuery();
